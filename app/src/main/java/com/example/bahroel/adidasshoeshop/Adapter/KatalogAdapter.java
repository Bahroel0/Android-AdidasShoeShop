...
public class KatalogAdapter extends RecyclerView.Adapter<KatalogAdapter.ViewHolder>{
    ...
    public KatalogAdapter(Context context, ArrayList<Produk> produkList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.list_produk_katalog,null));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            cardView = (CardView) itemView.findViewById(R.id.cv_produk_katalog);
        }
    }
}
